set -gx PATH $HOME/bin $HOME/.cargo/bin $HOME/go/bin $HOME/squashfs-root/usr/bin $HOME/.npm-global/bin /mnt/c/Program\ Files\ \(x86\)/Google/Chrome/Application $PATH
# alias fd=fdfind
...
set -gx VISUAL "/home/chris/bin/nvim"
